...
function calculateLite() {
    ...
    for (var i = start; xL < finalXL; i++) {
        ...
        try {
            if (math.isNaN(math.eval(derivEquation,scope = {x: xL,y: yL}))) throw "xato: qaysidir nuqtada funksiyangiz aniqlanmagan qiymatga baholandi. Ehtimol, 0 ga bo'lish xatosi, lekin etiborli bo'lishingiz kerak.";
